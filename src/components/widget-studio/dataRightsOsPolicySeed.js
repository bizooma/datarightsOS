// ONE-TIME SEED — NOT APPLIED YET, and not imported by any running code.
//
// This is the full 12-section DataRightsOS privacy policy, copied verbatim out of
// src/pages/PrivacyPolicy.jsx and converted from JSX to plain HTML. Nothing was
// summarized, condensed, reordered, or reworded: same twelve sections, same
// sub-processor list, same Google API Services Limited Use disclosure, word for word.
// The only changes are mechanical — JSX braces/entities become plain text, and
// <a> attributes are written out as HTML.
//
// Read it, then say the word and I will write it into the privacy_policy statement
// body for datarightsos.com and delete this file. After that the statement body is
// the single source and /privacy-policy renders from it.
export const DRO_PRIVACY_POLICY_HTML = `<p>This Privacy Policy describes how Bizooma, LLC, a Texas limited liability company ("Bizooma," "we," "us," "our"), collects, uses, stores, shares, and protects information in connection with DataRightsOS — the website datarightsos.com, the dashboard, the embeddable widget, and related services (collectively, the "Service"). It applies to account holders and their authorized team members who sign in to the DataRightsOS dashboard ("you"), including those who sign in using Google.</p>
